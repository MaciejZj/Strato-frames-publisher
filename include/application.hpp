...
private:
	...
	Socket_handler<cpu_temp_frame_t>* socket_handler;
...
public:
	...
	int exec() {
		...
		try {
			socket_handler = new Socket_handler<cpu_temp_frame_t>("sp.cfg", "cpu_temp", frame_topic::cpu_temp);
			
			cpu_temp_reader = new Cpu_temp_reader("dummy");
			running = true;
